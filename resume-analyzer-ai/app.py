...
class DeepSeekHelper:
    ...
    def __init__(self):
        ...
        self.api_key = "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"
        self.base_url = "https://openrouter.ai/api/v1/chat/completions"  # Correct endpoint
    
    def generate_interview_questions(self, resume_text, job_role, num_questions=10, difficulty="Intermediate"):
        ...
        prompt = f"""
        You are an experienced hiring manager. Generate {num_questions} {difficulty}-level interview questions 
        for a candidate applying for a {job_role} position based on the following resume information:
        
        Resume Details:
        {resume_text[:3000]}  # Truncate to avoid token limits
        
        The questions should:
        1. Cover both technical and behavioral aspects
        2. Be tailored to the candidate's experience and skills
        3. Include some challenging questions to assess depth of knowledge
        4. Be formatted as a numbered list with clear questions
        
        Return only the questions in markdown format with no additional commentary.
        """
        
        payload = {
            "model": "deepseek/deepseek-r1-zero:free",  # Update with actual model name if needed
            "messages": [
                {
                    "role": "user",
                    "content": prompt
...
class ResumeApp:
    ...
    def render_about(self):
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About Gamage Recruiters (Pvt) Ltd</h1>
        ...
        st.markdown(f"""
            <div class="profile-section">
                <h2 class="profile-name"> Gamage Recruiters (Pvt) Ltd</h2>
                <p class="profile-title">Gamage Recruiters is a growing recruitment company focused in Worldwide.</p>
                <div class="social-links">
                    <a href="https://www.linkedin.com/company/gamage-recruiters/?originalSubdomain=lk" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="gamagerecruiters@gmail.com" class="social-link" target="_blank">
                ...
                <p class="bio-text">
                    <h1>Overview</h1>
                    <h2>Our mission</h2>
                    "To showcase emerging market talent globally to provide a genuinely local solution to 
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "Our aim is to become the go-to organization for all human resource and business needs. We are
                    committed to providing exceptional service, expertise, professionalism, honesty, and integrity 
                    to all our clients and community members.
                    By extending our services across borders to emerging markets, we tap into a broad spectrum of talent from emerging countries and industries. Additionally, we have established a global footprint by sharing information and nurturing best practices within our executive search team to work regionally and globally. This helps companies fill the pool of leaders to use their potential and effectively retain their skills effectively. Our next strong ethic and area of interest is the introduction of diversity in the workplace."
                </p>
            </div>
        """, unsafe_allow_html=True)
    ...
    def render_analyzer(self):
        ...
        if uploaded_file:
            with st.spinner("Analyzing your document..."):
                ...
                # Render the interview preparation section
                self.render_interview_prep(analysis, text)
    ...
    def render_interview_prep(self, analysis_data, resume_text):
        """Render the interview preparation section """
        st.markdown("""
        ...
        # Get job role from analysis data or session state
        job_role = analysis_data.get('target_role', st.session_state.get('selected_role', 'your target role'))


        if job_role is None or job_role == 'your target role':
         job_role = "Unknown Role"  # Set a default value or handle this case as needed


        
        with st.expander("🔍 Generate Custom Interview Questions", expanded=True):
            st.write(f"Get questions tailored for **{job_role}** based on your resume content.")
            ...
            if st.button("✨ Generate Questions", type="primary"):
                ...
                with st.spinner("Generating tailored interview questions..."):
                    ...
                    # Combine resume text with analysis insights
                    prompt_text = f"""
                    Resume Summary:
                    {resume_text[:2000]}
                    ...
                    questions = deepseek_helper.generate_interview_questions(
                        prompt_text, 
                        job_role,
                        num_questions
                    )
        ...
        if 'generated_questions' in st.session_state:
            ...
            st.session_state.generated_questions.replace(r'\boxed{', '').replace(r'}', '')

            st.markdown(st.session_state.generated_questions, unsafe_allow_html=True)
            ...
            st.download_button(
                ...
                data=questions_text,
                file_name=f"{job_role.replace(' ', '_')}_interview_questions.md",
                mime="text/markdown"
            )
    ...
    def main(self):
        ...
        with st.sidebar:
            ...
            st.title("Gamage Recruiters (Pvt) Ltd")
